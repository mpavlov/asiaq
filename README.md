...
archive_threshold=              # A fraction number representing what the percentage of used space in the cluster should be after grooming by the archival process (float)
